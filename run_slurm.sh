...
5) python ppo_continuous_action_isaacgym.py --exp-name exp000 --env-id cma --seed 30 --track --capture-video;;
6) python ppo_continuous_action_isaacgym.py --exp-name exp000 --env-id dma --seed 10 --track --capture-video;;
7) python ppo_continuous_action_isaacgym.py --exp-name exp000 --env-id dma --seed 20 --track --capture-video;;
